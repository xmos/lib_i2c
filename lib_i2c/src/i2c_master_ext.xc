...
extends client interface i2c_master_if : {
  ...
  extern inline i2c_res_t write_reg_n_m(client interface i2c_master_if i,
                                   uint8_t device_addr,
                                   uint8_t reg[m],
                                   size_t m,
                                   uint8_t data[n],
  ...
  extern inline i2c_res_t write_reg_8_8(client interface i2c_master_if i,
                                   uint8_t device_addr, uint8_t reg,
                                   uint8_t data);

  extern inline i2c_res_t write_reg(client interface i2c_master_if i,
                                    uint8_t device_addr,
  ...
  extern inline i2c_res_t write_reg8_addr16(client interface i2c_master_if i,
                                       uint8_t device_addr, uint16_t reg,
                                       uint8_t data);
 ...
 extern inline i2c_res_t write_reg16(client interface i2c_master_if i,
                                uint8_t device_addr, uint16_t reg,
                                uint16_t data);
}
